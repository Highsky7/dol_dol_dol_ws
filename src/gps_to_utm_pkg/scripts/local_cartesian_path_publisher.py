...
default_csv = os.path.join(pkg_path, "data", "engineering_a.csv")
...
REF_LAT = rospy.get_param("~ref_lat", 37.541647)               # 기준 위도
REF_LON = rospy.get_param("~ref_lon", 127.078786)              # 기준 경도
R_EARTH = 6378137.0
