...
def lidar_callback(msg, args):
    ...
    voxelnext_model, lidar_dataset, pub_2D_detected_objects, pub_center_detected_objects = args
...
def main():
    ...
    rospy.init_node('voxelnext_2D_and_center_object_detect', anonymous=False)
    ...
    rospy.Subscriber(
        ...
        PointCloud2,
        lidar_callback,
        callback_args=(voxelnext_model, lidar_dataset, pub_2D_detected_objects, pub_center_detected_objects),
        queue_size=1,
        buff_size=2**24
    )
