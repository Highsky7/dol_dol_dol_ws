...
def make_parser():
    ...
    parser.add_argument('--source', type=str,
                        # default='2',
                        default='/home/highsky/Videos/Webcam/left_bev_params_1.mp4',
...
def detect_and_publish(opt, pub_mask, pub_steering, pub_lane_status):
    ...
    # m_per_pixel_y = 0.003015625
    m_per_pixel_y = 0.004015625
    # y_offset_m = 1.8
    y_offset_m = 1.83
    # m_per_pixel_x = 0.002734375
    m_per_pixel_x = 0.00278125
